...
<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-8">
      <div>
        <h1 class="text-2xl font-bold text-gray-800">Assessment Saya</h1>
        <p class="text-sm text-gray-500 mt-1">Kelola dan pantau status Assessment Anda</p>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
        <div class="p-4">
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="relative">
              <input type="text" placeholder="Cari Assessment..." v-model="filters.search"
