    ...
    <transition name="scale-fade" mode="out-in" appear>
      <div :key="$route.name" class="relative w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-5xl z-10">
        ...
        <div :class="[
          ...
          <!-- Right: Form Section -->
          <div class="p-4 sm:p-6 lg:p-12 flex items-center">
            <div class="w-full max-w-sm sm:max-w-md mx-auto">
              ...
              <div class="mb-4 lg:mb-8">
                ...
                <p class="text-[10px] lg:text-xs mt-1 lg:mt-2" :class="{ 'text-gray-500': !isDarkMode, 'text-gray-400': isDarkMode }">
                  Belum terdaftar?
              ...
              <form class="space-y-3 lg:space-y-5" @submit.prevent="handleLogin">
                <!-- Email Input -->
                <div class="group">
                  <label for="email" class="block text-xs lg:text-sm font-semibold mb-1 lg:mb-2" :class="{ 'text-gray-700': !isDarkMode, 'text-gray-300': isDarkMode }">
                    Email
                  </label>
                  <div class="relative">
                ...
                <div class="group">
                  ...
                  <div class="relative">
                    ...
                    <input
                      ...
                      class="block w-full pl-12 pr-24 py-2 lg:py-3 rounded-lg text-xs lg:text-sm font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 border"
                      :class="!isDarkMode ? 'bg-slate-50 border-slate-200 text-gray-900 placeholder-gray-400 focus:bg-white focus:border-blue-500 focus:ring-blue-500/20 hover:border-slate-300' : 'bg-dark-surface/80 border-dark-border text-gray-100 placeholder-gray-500 focus:border-blue-400 focus:ring-blue-400/20'"
