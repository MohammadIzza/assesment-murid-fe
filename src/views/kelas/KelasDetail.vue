<template>
  ...
  <div v-if="showDeleteModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div v-else-if="kelasStore.getCurrentKelas" class="space-y-8">
        <!-- Profile Card -->
        <div :class="[
          ...
          <div class="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 px-8 py-10">
            <div class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-6">
              ...
              <div class="flex-1">
                <h2 class="text-2xl font-bold text-white mb-2">{{ kelasStore.getCurrentKelas.nama_kelas || 'Nama Kelas Tidak Tersedia' }}</h2>
                <p class="text-blue-100 text-base mb-3">{{ kelasStore.getCurrentKelas.tahun_ajaran || 'Tahun Ajaran Tidak Tersedia' }}</p>
                <div class="flex flex-wrap gap-2">
                  <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium" :class="getStatusClass(kelasStore.getCurrentKelas)">
                  ...
                  <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium" :class="getTingkatClass(kelasStore.getCurrentKelas.tingkat)">
              ...
              <div class="flex flex-col space-y-2 md:space-y-0 md:space-x-3 md:flex-row">
                <button @click="editKelas" class="inline-flex items-center justify-center px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-lg hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-white/50 transition-all duration-200 transform hover:scale-105">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div :class="[
                  ...
                  <div class="space-y-4">
                    <div class="flex justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
                      ...
                      <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium" :class="getSchoolClass(kelasStore.getCurrentKelas.id_sekolah)">
                    ...
                    <div class="flex justify-between items-center py-2 border-b border-gray-200 last:border-b-0">
                      ...
                      <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium" :class="getWaliKelasClass(kelasStore.getCurrentKelas.id_wali_kelas)">
